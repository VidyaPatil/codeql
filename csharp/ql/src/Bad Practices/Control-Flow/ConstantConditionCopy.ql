...
abstract class ConstantConditionCopy extends Expr {
...
class ConstantBooleanConditionCopy extends ConstantConditionCopy {
  boolean b;

  ConstantBooleanConditionCopy() { isConstantCondition(this, b) }
...
class ConstantIfConditionCopy extends ConstantBooleanConditionCopy {
  ConstantIfConditionCopy() {
    this = any(IfStmt is).getCondition().getAChildExpr*() or
    this = any(ConditionalExpr ce).getCondition().getAChildExpr*()
  }

  override predicate isWhiteListed() {
    ConstantBooleanConditionCopy.super.isWhiteListed()
    or
...
class ConstantLoopConditionCopy extends ConstantBooleanConditionCopy {
  ConstantLoopConditionCopy() { this = any(LoopStmt ls).getCondition() }
...
class ConstantNullnessConditionCopy extends ConstantConditionCopy {
  boolean b;

  ConstantNullnessConditionCopy() {
...
class ConstantMatchingConditionCopy extends ConstantConditionCopy {
  boolean b;

  ConstantMatchingConditionCopy() {
    forex(ControlFlow::Node cfn | cfn = this.getAControlFlowNode() |
...
from ConstantConditionCopy c, string msg
where
